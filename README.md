...
Payment verification — buyer taps "I've Paid"; every admin in
ADMIN_USER_IDS gets a DM with Approve/Reject buttons (manual
verification stops fake-payment fraud — no auto-trust of a button tap).
